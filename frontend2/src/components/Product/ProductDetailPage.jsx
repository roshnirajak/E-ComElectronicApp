        ...
        <div className="bg-slate-300 dark:bg-gray-800 p-5  ">
            ...
            <div className="max-w-screen-xl mx-auto p-4">
                ...
                <div className="py-10">
                    ...
                    <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">CX09-FLTUX IC</h1>
                    ...
                    <div className="sm:flex sm:justify-between sm:gap-10">
                        ...
                        <p className=" mb-6 text-lg text-gray-500  dark:text-gray-400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.
